...
class myframe
{
	...
	myframe()
	{	
		f=new JFrame("JOLLY BELLY");
		f.getContentPane().setLayout(null);
		l=new JLabel("JOLLY BELLY");
		l1=new JLabel("Customer ID");
		t1=new JTextField(15);
		l2=new JLabel("Customer NAME");
		t2=new JTextField(15);
		l3=new JLabel("LAST VISIT");
		t3=new JTextField(25);
		l4=new JLabel("REVIEWS");
		...
		b4.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				...
				t3.setText(a.validity.substring(0,20));
				t4.setText(a.dob.substring(0,20));
			}
		...
		l.setBounds(120,40,200,20);
		l.setForeground(Color.magenta);
		l.setFont(new Font("Serif",Font.BOLD,28));
		l1.setBounds(50,110,120,27);
		l2.setBounds(50,150,120,27);
		l3.setBounds(50,190,120,27);
		l4.setBounds(50,230,120,27);
		t1.setBounds(220,110,180,27);
		t2.setBounds(220,150,180,27);
		t3.setBounds(220,190,180,27);
